...
for (i in 1:4){
ranges[i,]<-c(min(firstPool.parm[,i]),max(firstPool.parm[,i]),firstPool.parm[bestfit$C1_index,i])
ranges[i+4,]<-c(min(secondPool.parm[,i]),max(secondPool.parm[,i]),secondPool.parm[bestfit$C2_index,i])
}
